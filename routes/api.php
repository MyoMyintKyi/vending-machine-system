...
$router->post('/api/products/{id}/purchase', [ProductApiController::class, 'purchase'], [ApiAuthMiddleware::class]);

$router->get('/api/transactions', [TransactionApiController::class, 'index'], [[ApiAuthMiddleware::class, 'Admin']]);
$router->get('/api/users/{id}/transactions', [TransactionApiController::class, 'userTransactions'], [ApiAuthMiddleware::class]);